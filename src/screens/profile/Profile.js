...
class Profile extends Component {
    ...
    componentDidMount() {
        if (this.state.isLoggedIn) {
            ...
            let data = null;
            if (this.state.isLoggedIn) {
                let url = "https://graph.instagram.com/me/media?fields=id,caption&access_token=" + this.state.accessToken
                console.log('url:',url)
                fetch(url,{
                    method:'GET',
                  }).then((response) =>{
                    ...
                    api1data.forEach(element => {
                        ...
                        let url2="https://graph.instagram.com/" + element.id + "?fields=id,media_type,media_url,username,timestamp&access_token=" + this.state.accessToken
                        ...
                        fetch(url2,{
                            ...
                            api2data = {...api2data,id:element.id, caption:element.caption,likes_count: 5 ,user_has_liked: false}
                            let findata=[]
                            if ((this.state.imagesData).length > 0) {
                                this.state.imagesData.forEach(ima => {findata.push(ima)})
                                    ...
                                    <div className="flex-container">
                                        <div className="left">
                                            <div className="profile-summary">
                                                <img className="profile-image" src={profileImage} alt={this.state.fullName} />
                                            </div>
                                        </div>
                                            ...
                                            <div className={classes.modalStyle}>
                                                ...
                                                <div className="modal-right">
                                                    <div className="right-top">
                                                        <img className="modal-profile-icon" src={profileImage} alt={this.state.fullname} />
